...
EXEC dbo.eliminarVista N'VW_CAL_DAILY';

-- === Insert Vistas ===

                        DECLARE @VistaId NVARCHAR(250) = N'VW_CAL_DAILY';
                        ...
                        VALUES
                            (1, NULL, N'VW_CAL_DAILY', N'Vista que carga grilla desde SP dbo.storedProcedurePrueba y expone un Calendar para @Fecha', SYSUTCDATETIME(), N'1.0', NULL, @VistaId, N'go', 0, 14);
